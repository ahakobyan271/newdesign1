...
var submitbutton = document.getElementById('submitpromo')
var promoarray = ["Anush", "janna", "mher"]
var promoforcheck = document.getElementById('promo-forcheck')


submitpromo.addEventListener('click', uniquepromo)

function uniquepromo() {
  ...
  for (var item in promoarray) {
    if (promoarray[item].toLowerCase() === promoforcheck.value.toLowerCase()) {
      ...
      //localStorage.setItem("promo", promoforcheck.value)

      promo.value = promoforcheck.value //localStorage.getItem("promo")
    }
